...
|1.5|10/08/2024|Adição de conteudo em visão lógica e correções gerais|[Pablo Guilherme](https://github.com/PabloGJBS) e  [Suzane Duarte](https://github.com/suzaneduarte)|[Luana Torres](https://github.com/luanatorress)|10/08/2024|Excelente|
|1.6|14/08/2024|Adição da segunda versão do DER e o do DLD|[Ana Letícia](https://github.com/analeticiaa) e [Cleber Brant](https://github.com/Cleberbrant)|[Edilberto](https://github.com/edilbertocantuaria)|15/08/2024|Excelente|
...
|1.9|15/08/2024|Adição dos estilos arquiteturais|[Pablo Guilherme](https://github.com/PabloGJBS) e [João Pedro](https://github.com/jpanacleto2) |[Luana Torres](https://github.com/luanatorress)|15/08/2024|Excelente|
...
| Versão | Data da alteração |      Alteração      |     Responsável     |                     Revisor                      | Data de revisão | Significância da Contribuição para o Projeto |
| :----: | :---------------: | :-----------------: | :-----------------: | :----------------------------------------------: | :-------------: | :-: |
|  1.0   |    12/08/2024     | Criação do template e adicionando introdução e metodologia do artefato  | [Suzane Duarte](https://github.com/suzaneduarte) | [Eduardo Rodrigues](https://github.com/Eduardo-RFarias) |     12/08/2024   | Excelente |
|  1.1   |    15/08/2024     | Adicionando Reutilização de código utilizando Factory Method  | [Suzane Duarte](https://github.com/suzaneduarte) | [João Pedro Anacleto](https://github.com/jpanacleto2) |     15/08/2024    | Excelente |
|  1.2   |    16/08/2024     | Adicionando Reutilização de código utilizando componentização  | [Suzane Duarte](https://github.com/suzaneduarte) | [Edilberto Cantuaria](https://github.com/edilbertocantuaria) |     16/08/2024     | Excelente |
|  1.3   |    16/08/2024     | Adicionando Reutilização de código utilizando JWT  | [Suzane Duarte](https://github.com/suzaneduarte) | [Pablo Guilherme](https://github.com/PabloGJBS) |     16/08/2024   | Excelente |
|  1.4   |    16/08/2024     | Adicionando Reutilização de código utilizando Factory Method  | [Suzane Duarte](https://github.com/suzaneduarte) | [Pablo Guilherme](https://github.com/PabloGJBS)  |  16/08/2024 |     16/08/2024   | Excelente |
|  1.5   |    16/08/2024     | Adicionando Reutilização de código utilizando Factory Method  | [Suzane Duarte](https://github.com/suzaneduarte) | [Eduardo Rodrigues](https://github.com/Eduardo-RFarias)  |  16/08/2024 |     16/08/2024   | Excelente |

*Tabela 2: Participações da equipe no desenvolvimento do Módulo Reutilização de Software*

### Iniciativas Extras: 

- Visão de Bancos de Dados, realizada por [Ana Letícia](https://github.com/analeticiaa) e [Luana Torres](https://github.com/luanatorress). 

- Refatoração do GoF Criacional utilizando o Método de Fábrica conforme levantamentos realizadas pela docente na terceira entrega. O rastreamento dessa alteração pode ser encontrada a partir [desse commit](https://github.com/UnBArqDsw2024-1/2024.1_G8_UnBreja/commit/a658dc18401c463690f055c9ac9030005d52d94a), a qual os membros [Suzane Duarte](https://github.com/suzaneduarte) e [João Pedro Anacleto](https://github.com/jpanacleto2) realizam as devidas modificações pertinentes. 

- Implementação da lógica do BackEnd e do Banco de Dados por parte da equipe composta por: [Cleber Brant](https://github.com/Cleberbrant), [Eduardo Rodrigues](https://github.com/Eduardo-RFarias), [Wesley Lira](https://github.com/Weslin-0101) e [Artur Seppa](https://github.com/artur-seppa). 
...
|[Suzane Duarte](https://github.com/suzaneduarte) | Demonstrou excelente capacidade de organização ao gerenciar as tarefas dos membros e assegurar a participação ativa de todos em diversos artefatos. Contribuiu na criação de páginas no front-end e na documentação. Acredito que as tarefas foram deixadas para o último momento, o que gerou estresse desnecessário e modificações imprudentes no código ao final da entrega. No geral, a colaboração e o comprometimento de alguns membros da equipe foram essenciais para realização da entrega. |
|[João Pedro Anacleto](https://github.com/jpanacleto2)| Demonstrou iniciativa no desenvolvimento da criação dos artefatos juntamente com a correção dos artefatos referentes a entregas anteriores, buscando sempre comunicação com outros membros para validações em conjunto.  |
|[Cleber Brant](https://github.com/Cleberbrant) | Demonstrou excelente capacidade para gerenciar a equipe de backend, desde a idealização do banco e entidades, criação da segunda versão do diagramas de modelo de dados, idealização da arquitetura do projeto, até nas tomadas de decisão da equipe, para conseguirmos fazer a entrega de um MVP. |
...
|[Edilberto Cantuaria](https://github.com/edilbertocantuaria) |Desempenhou um papel fundamental no front-end e na documentação do projeto, contribuindo de maneira eficiente para a construção das interfaces e para a organização dos artefatos documentais. Teve uma notória participação, iniciando o projeto e participando de pair-programming. No entanto, uma maior antecipação na execução das tarefas poderia ter evitado alguns contratempos próximos aos prazos finais.  |
...
|  1.5 |    16/08/2024     | Atualização na tabela de comentarios gerais | [Edilberto Cantuaria](https://github.com/edilbertocantuaria) | [Artur Seppa](https://github.com/artur-seppa) |    A realizar    |
|  1.6 |    16/08/2024     | Atualização na tabela de comentarios gerais | [Cleber Brant](https://github.com/Cleberbrant) | [Wesley Lira](https://github.com/Weslin-0101) |    A realizar    |
|  1.7 |    16/08/2024     | Adicionando tópico Iniciativas Extras | [Suzane Duarte](https://github.com/suzaneduarte) | [Pablo Guilherme](https://github.com/PabloGJBS)|    A realizar    |
