...
## 1.2.3. BPMN do produto

### 1.2.3.1 BPMN do produto: cadastro, login e manuntenção de informações
...
### 1.2.3.4 BPMN do produto: notícias e eventos
