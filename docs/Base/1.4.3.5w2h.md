...
<small style="color: purple; font-weight: bold;">Figura 1: 5W2H Login Social.</small>

### 3.2. Manutenção de suas informações pessoais, gostos e objetivos
<img src="../assets/5w2h/manutencao-informacoes-pessoais.png">
<small style="color: purple; font-weight: bold;">Figura 2: 5W2H Manutenção de suas informações pessoais, gostos e objetivos.</small>

### 3.3. Buscar pessoas para interagir baseado em sugestões
<img src="../assets/5w2h/buscas-pessoas.png">
<small style="color: purple; font-weight: bold;">Figura 3: 5W2H Buscar pessoas para interagir baseado em sugestões.</small>

### 3.4. Chat de interaçao pós match
<img src="../assets/5w2h/chat-interacao.png">
<small style="color: purple; font-weight: bold;">Figura 4: 5W2H Chat de interaçao pós match.</small>

### 3.5. Divulgação de noticias e eventos
<img src="../assets/5w2h/divulgacao-noticias.png">
<small style="color: purple; font-weight: bold;">Figura 5: 5W2H Divulgação de noticias e eventos.</small>
